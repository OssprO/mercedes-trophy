 ...
 *
 * If you are making your theme translatable, you should replace 'mercedestrophy'
...
function optionsframework_options() {
	...
	$options[] = array(
		'name' => __('Header Meta', 'mercedestrophy'),
		'type' => 'heading');

// Standard Meta
	$options[] = array(
		'name' => __('Head ID', 'mercedestrophy'),
		'desc' => __("", 'mercedestrophy'),
		'id' => 'meta_headid',
		'std' => 'mercedestrophy',
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'mercedestrophy'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'mercedestrophy'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'mercedestrophy'),
		'desc' => __('Populates meta author tag.', 'mercedestrophy'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'mercedestrophy'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'mercedestrophy'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'mercedestrophy'),
		'desc' => __('', 'mercedestrophy'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'mercedestrophy'),
		'desc' => __('', 'mercedestrophy'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'mercedestrophy'),
		'desc' => __('Application Name', 'mercedestrophy'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('Tile Color', 'mercedestrophy'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('Tile Image', 'mercedestrophy'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'mercedestrophy'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'mercedestrophy'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('twitter:site (@username of website)', 'mercedestrophy'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'mercedestrophy'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('twitter:description (maximum 200 characters)', 'mercedestrophy'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('twitter:url (url for the content)', 'mercedestrophy'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'mercedestrophy'),
		'desc' => __('og:title', 'mercedestrophy'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('og:description', 'mercedestrophy'),
		'id' => 'meta_app_fb_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('og:url', 'mercedestrophy'),
		'id' => 'meta_app_fb_url',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'mercedestrophy'),
		'desc' => __('og:image', 'mercedestrophy'),
